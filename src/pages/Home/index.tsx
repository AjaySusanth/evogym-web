...
const Home = ({setSelectedPage}: Props) => {
  ...
  return (
    ...
    <section id="home" className="gap-16 bg-gray-20 py-10 md:pt-10 md:pb-0">
        ...
        >
            ...
            {/* Image */}
            <div className="flex basis-3/5 justify-center md:justify-items-end md:mt-16 md:ml-40 md:z-10">
